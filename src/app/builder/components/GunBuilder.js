...
export default function GunBuilder( {data, parameters, setParameters, receiveData, addAttachment, removeAttachment} ) {
    ...
    return (
        <div className="h-[48rem] overflow-hidden">
            <div className={background_details}>
                ...
                <GunDisplay isOpen={data !== null} parameters={parameters} setParameters={setParameters}/>  
            </div>
